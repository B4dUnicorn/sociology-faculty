    ...
    master: [
      {
        ...
        minScore: "50",
        description:
          "Программа сочетает специальную социологическую подготовку с обучением проектной деятельности в сфере новых медиа. Основу образования составляют базовые социологические дисциплины, специальный акцент делается на изучении новых медиа — компьютерных, цифровых, сетевых коммуникаций и технологий.",
        skills: [
      ...
      {
        name: "Социология управления и организации",
        code: "39.04.01",
        duration: "2 года",
        form: "очная",
        description:
          "Магистерская программа «Социология управления и организации» направлена на углубленное изучение управленческих процессов, организационной культуры и поведения в организациях. Программа готовит специалистов, способных анализировать и развивать управленческие практики в различных типах организаций.",
        skills: [
          "Анализировать организационные структуры и управленческие процессы",
          "Проводить диагностику организационной культуры",
          "Разрабатывать стратегии развития организаций",
          "Осуществлять мониторинг эффективности управленческих решений",
          "Консультировать руководство по вопросам управления персоналом"
        ],
        career: [
          "HR-аналитик",
          "Консультант по организационному развитию",
          "Аналитик в сфере управления",
          "Руководитель отдела организационного развития",
          "Научный сотрудник в области организационной социологии"
        ]
      },
      {
        name: "Гендерные исследования и равенство возможностей",
        code: "39.04.01",
        duration: "2 года",
        form: "очная",
        description:
          "Программа направлена на изучение гендерных аспектов социальной жизни, вопросы равенства, дискриминации и социальной справедливости. Подготовка проводится с акцентом на аналитику и практическое применение знаний.",
        skills: [
          "Проводить гендерный анализ политик и законодательства",
          "Разрабатывать антидискриминационные стратегии",
          "Организовывать просветительские кампании",
          "Анализировать влияние гендера на рынок труда и образование",
          "Работать с сообществами и правозащитными организациями"
        ],
        career: [
          "Гендерный эксперт",
          "Специалист по равенству в госорганах",
          "Консультант по вопросам диверсификации",
          "Исследователь в области гендерной политики",
          "Специалист по внутреннему коммуникационному климату в компаниях"
        ]
      },
      {
        name: "Социальное управление в условиях цифровизации",
        code: "39.04.01",
        duration: "2 года",
        form: "очная",
        description:
          "Программа посвящена управлению социальными процессами в условиях цифровой трансформации общества. Слушатели осваивают инструменты цифрового управления, электронного взаимодействия и автоматизации социального планирования.",
        skills: [
          "Разрабатывать цифровые стратегии управления",
          "Оптимизировать процессы с помощью цифровых технологий",
          "Управлять данными и использовать их в принятии решений",
          "Создавать системы цифрового взаимодействия",
          "Анализировать эффекты цифровизации на общество"
        ],
        career: [
          "Digital-менеджер в органах власти",
          "Эксперт по цифровому управлению",
          "Консультант по цифровым преобразованиям",
          "Аналитик в сфере цифрового госуправления",
          "Руководитель цифровых социальных проектов"
        ]
      }
    ]
  };
